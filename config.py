...
BOT_NAME = getenv("BOT_NAME" , "𝐊𝖺𝗏𝗒𝖺 ꭙ 𝐌ᴜsɪᴄ ♪ [ ᴛᴘʙ ]™")
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/ankitsingh12134/Sonali_music-",)
...
autoclean = []
confirmer = {}
START_IMG_URL = getenv("START_IMG_URL", "https://files.catbox.moe/l7n2co.jpg")
PING_IMG_URL = getenv("PING_IMG_URL", "https://files.catbox.moe/l7n2co.jpg")
